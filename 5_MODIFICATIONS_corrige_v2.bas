...
'#  Version corrigee - POINTS 1 et 2
'#
'#  POINT 2 : cases a cocher / champs Oui-Non
'#    Prerequis : migration Texte -> Oui/Non des cinq champs
'#    FAST, CONSULTATION CPLE Recommande, ALERTE DEFAUT,
'#    VALIDATION AINDEP, URGENCE.
'#
'#  POINT 1 : moment de la persistance
'#    Dans BeforeUpdate, Me.Controle.Value contient encore
'#    l'ANCIENNE valeur : la nouvelle saisie n'est disponible
'#    que dans .Text. Toutes les procedures ecrivaient donc en
'#    base la valeur precedente, avec un decalage permanent
'#    d'un cran, et CalculerEtMettreAJourDelais recalculait
'#    sur cette valeur perimee.
'#
'#    - 36 procedures sans validation : basculees en AfterUpdate
'#    - 27 procedures avec validation : scindees en deux,
'#      BeforeUpdate pour le controle de coherence (lecture en
'#      .Text), AfterUpdate pour l'ecriture et le recalcul
'#
'#  RESTE A TRAITER, hors de ce lot :
...
Public Sub Texte14_BeforeUpdate(Cancel As Integer) ' Attribution
    ...
    attributionDate = Nz(Me.Texte14.Text, "") ' Attribution
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte14_AfterUpdate()
...
Public Sub Texte15_BeforeUpdate(Cancel As Integer)
    ...
    priseEnChargeDate = Nz(Me.Texte15.Text, "") ' Prise en charge
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte15_AfterUpdate()
    Call UpdateTableField("PRISE EN CHARGE", Me.Texte15)
    Call CalculerEtMettreAJourDelais
End Sub
' ETAT
Public Sub Modifiable16_AfterUpdate()
    Call UpdateTableField("ETAT", Me.Modifiable16)
End Sub
' DVA NOTE
Public Sub Texte17_AfterUpdate()
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte19_AfterUpdate()
...
Public Sub Texte20_BeforeUpdate(Cancel As Integer)
    ...
    envoie1Date = Nz(Me.Texte20.Text, "") ' ENVOIE 1 MARCHE
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte20_AfterUpdate()
...
Public Sub Texte21_BeforeUpdate(Cancel As Integer)
    ...
    retour1Date = Nz(Me.Texte21.Text, "") ' RETOUR 1 MARCHE
    ' Vérifier si RETOUR 1 est rempli mais pas ENVOIE 1
    If retour1Date <> "" And envoie1Date = "" Then
        MsgBox "Attention : La date de retour N°1 ne peut pas être remplie si la date d'envoi N°1 est vide.", vbExclamation
        Cancel = True ' Empêcher la mise à jour
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte21_AfterUpdate()
...
Public Sub Texte22_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    envoie1Date = Nz(Me.Texte20.Value, "") ' ENVOIE 1 MARCHE
    envoie2Date = Nz(Me.Texte22.Text, "") ' ENVOIE 2 MARCHE
    retour1Date = Nz(Me.Texte21.Value, "")   ' RETOUR 1 MARCHE
    ' Vérifier si ENVOIE 1 est rempli, RETOUR 1 est vide, et ENVOIE 2 est en cours de modification
    If IsDate(envoie1Date) And Not IsDate(retour1Date) And Not IsNull(Me.Texte22.Text) Then
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte22_AfterUpdate()
...
Public Sub Texte23_BeforeUpdate(Cancel As Integer)
    ...
    retour2Date = Nz(Me.Texte23.Text, "") ' RETOUR 2 MARCHE
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte23_AfterUpdate()
    Call UpdateTableField("RETOUR 2 MARCHE", Me.Texte23)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRES J MARCHE
Public Sub Texte24_AfterUpdate()
...
Public Sub Texte505_BeforeUpdate(Cancel As Integer)
    ...
    envoieSignataireDate = Nz(Me.Texte505.Text, "") ' DATE ENVOIE AU SIGNATAIRE
    ' *** NOUVELLE LOGIQUE ***
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte505_AfterUpdate()
...
Public Sub Texte25_BeforeUpdate(Cancel As Integer)
    ...
    dateSignatureDate = Nz(Me.Texte25.Text, "") ' DATE SIGNATURE
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte25_AfterUpdate()
...
Public Sub Texte26_BeforeUpdate(Cancel As Integer)
    ...
    envoieDCECOODate = Nz(Me.Texte26.Text, "") ' ENVOIE DCE/COO
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte26_AfterUpdate()
...
Public Sub Texte27_BeforeUpdate(Cancel As Integer)
    ...
    retourDCECOODate = Nz(Me.Texte27.Text, "") ' RETOUR DCE/COO
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte27_AfterUpdate()
    Call UpdateTableField("RETOUR DCE/COO", Me.Texte27)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ DCEE/COO
Public Sub Texte28_AfterUpdate()
...
Public Sub Texte29_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieDGADate = Nz(Me.Texte29.Text, "") ' ENVOIE DGA
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte29_AfterUpdate()
...
Public Sub Texte30_BeforeUpdate(Cancel As Integer)
    ...
    retourDGADate = Nz(Me.Texte30.Text, "") ' RETOUR DGA
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte30_AfterUpdate()
    Call UpdateTableField("RETOUR DGA", Me.Texte30)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ DGA
Public Sub Texte31_AfterUpdate()
...
Public Sub Texte32_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieDGDate = Nz(Me.Texte32.Text, "") ' ENVOIE DG
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte32_AfterUpdate()
...
Public Sub Texte654_BeforeUpdate(Cancel As Integer)
    ...
    retourDGDate = Nz(Me.Texte654.Text, "") ' RETOUR DG
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte654_AfterUpdate()
    Call UpdateTableField("RETOUR DG", Me.Texte654)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ DG
Public Sub Texte33_AfterUpdate()
...
Public Sub Texte34_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieRISQCREDate = Nz(Me.Texte34.Text, "") ' ENVOIE RISQCRE
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte34_AfterUpdate()
...
Public Sub Texte35_BeforeUpdate(Cancel As Integer)
    ...
    retourRISQCREDate = Nz(Me.Texte35.Text, "") ' RETOUR RISQCRE
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte35_AfterUpdate()
    Call UpdateTableField("RETOUR RISQCRE", Me.Texte35)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ RISQCRE
Public Sub Texte36_AfterUpdate()
...
Public Sub Texte37_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieCADate = Nz(Me.Texte37.Text, "") ' ENVOIE CA
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte37_AfterUpdate()
...
Public Sub Texte38_BeforeUpdate(Cancel As Integer)
    ...
    retourCADate = Nz(Me.Texte38.Text, "") ' RETOUR CA
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte38_AfterUpdate()
    Call UpdateTableField("RETOUR CA", Me.Texte38)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ CA
Public Sub Texte39_AfterUpdate()
...
Public Sub Texte40_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieAUTRESPCRUDate = Nz(Me.Texte40.Text, "") ' ENVOIE AUTRESPCRU
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte40_AfterUpdate()
...
Public Sub Texte41_BeforeUpdate(Cancel As Integer)
    ...
    retourAUTRESPCRUDate = Nz(Me.Texte41.Text, "") ' RETOUR AUTRESPCRU
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte41_AfterUpdate()
    Call UpdateTableField("RETOUR AUTRESPCRU", Me.Texte41)
    Call CalculerEtMettreAJourDelais
End Sub
' AUTRESJ AUTRESPCRU
Public Sub Texte42_AfterUpdate()
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Modifiable43_AfterUpdate()
    Call UpdateTableField("DECISION", Me.Modifiable43)
End Sub
' MONTANT ACCORDE
Public Sub Texte44_AfterUpdate()
...
Public Sub Texte45_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureFinale = Nz(Me.Texte45.Text, "") ' DATE SIGNATURE FINAL
    envoieDCECOODate = Nz(Me.Texte26.Value, "") ' ENVOIE DCE/COO
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte45_AfterUpdate()
...
Public Sub Texte46_BeforeUpdate(Cancel As Integer)
    ...
    dateEnvoieTrame = Nz(Me.Texte46.Text, "") ' DATE ENVOIE TRAME
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte46_AfterUpdate()
...
Public Sub Texte47_BeforeUpdate(Cancel As Integer)
    ...
    dateNotification = Nz(Me.Texte47.Text, "") ' Date de notification
...
Public Sub Texte815_BeforeUpdate(Cancel As Integer)
    ...
    ' Récupérer les dates depuis les champs (en gérant les valeurs Null)
    dateSignatureDate = Nz(Me.Texte25.Value, "") ' DATE SIGNATURE
    envoieCORISQDate = Nz(Me.Texte815.Text, "") ' ENVOIE CORISQ
    ' Vérifier si la date d'envoi est remplie alors que la date de signature est vide
...
' --- PERSISTANCE ------------------------------------------
' Non execute si la validation ci-dessus a pose Cancel = True.
Public Sub Texte815_AfterUpdate()
...
Public Sub Texte818_BeforeUpdate(Cancel As Integer)
    ...
    retourCORISQDate = Nz(Me.Texte818.Text, "") ' RETOUR CORISQ
    ' Vérifier si la date de retour est remplie alors que la date d'envoi est vide
